...
const METRICS: MetricDefinition[] = [
  ...
  },
  {
    ...
    formula: "Ticket Quality error rows with Date of Occurrence inside the selected date range / TCR Total rows x 100.",
    columns: ["Ticket Quality: Date of Occurance / Date of Occurrence", "TCR Total: data rows"],
    note: "Lower is better. The error file is date-aware, so changing the dashboard date range changes the numerator.",
  },
  {
