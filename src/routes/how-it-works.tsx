...
const METRICS: MetricSpec[] = [
  ...
  },
  {
    ...
    formula: "saved value for each selected Monday-Friday week",
    columns: [],
    why: "The user selects a true work-week range such as Monday through Friday. The range detail view shows saved weeks; dashboard editors can delete a value and admins can edit it.",
  },
  {
    key: "driver_safety",
    label: "Safety",
  ...
  },
  {
    ...
    target: "<= 1",
    source: "Manual entry using Monday-Friday week ranges",
    formula: "saved weekly total for missed jobs + late jobs + client callbacks + reworks",
    columns: [],
    why: "These exceptions are tracked by operations because some missed jobs do not create a ticket row. The dashboard shows selected weeks without averaging them.",
  },
  {
    key: "status_snapshot",
