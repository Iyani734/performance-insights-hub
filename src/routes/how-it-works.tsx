...
const METRICS: MetricSpec[] = [
  ...
  },
  {
    ...
    target: "≤ 2%",
    source: "Total Invoiced export",
    formula: "count(invoiced tickets where Void Reason is set) ÷ count(all invoiced tickets) × 100",
    columns: ["Void Reason"],
    why: "Void reasons flag tickets that had to be corrected — a lower percentage means cleaner data reaches the customer.",
  },
  {
    ...
    target: "≤ 3 days",
    source: "Total Invoiced export",
    formula: "average of (end-of-week − Date Recv) across invoiced tickets, in days",
    columns: ["Date Recv"],
    why: "How quickly work moves from received to invoiced. Shorter cycles mean faster cash flow.",
  },
  {
